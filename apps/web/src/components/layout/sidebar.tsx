    ...
    <aside className="flex h-full w-[264px] flex-col gap-2 bg-gradient-to-br from-[var(--sidebar-bg)] to-[var(--sidebar-bg-2)] p-7 6">
      ...
      <div className="flex items-center gap-3 pb-7">
        ...
        <div className="flex flex-col">
          <span className="font-heading text-[17px] font-bold text-white">CardioPredict</span>
      ...
      <nav className="flex flex-col gap-1">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <item.icon
                className={cn("h-5 w-5", active ? "text-white" : "text-[#9FB2CC]")}
              />
              {item.label}
            </Link>
          );
      ...
      <div className="rounded-[14px] border border-white/[0.12] bg-white/[0.08] p-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-white">Modelo Ativo</span>
        </div>
        <p className="mt-2 text-[11px] text-[#9FB6D4]">Ensemble · padrão da API</p>
      </div>
      ...
      <div className="flex items-center gap-3 px-1 pt-0 pb-1">
        ...
        <div className="flex flex-col flex-1">
          <span className="text-[13px] font-semibold text-white">Dra. Renata Lima</span>
