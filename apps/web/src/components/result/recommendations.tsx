  ...
  return (
    <Card className="bg-primary p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-heading text-base font-bold text-primary-foreground">Recomendações</h3>
      </div>
      <ul className="flex flex-col gap-3">
        {recommendations.map((rec, index) => (
          <li key={index} className="flex items-start gap-2 text-sm text-primary-foreground/70">
