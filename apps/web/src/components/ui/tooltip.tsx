...
function TooltipContent({
  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="bg-foreground fill-foreground z-50 size-2.5 translate-y-[calc(-50%_-_0.125rem)] rotate-45 rounded-[0.125rem] data-[side=left]:translate-x-[-0.09375rem] data-[side=right]:translate-x-[0.09375rem]" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  );
}
