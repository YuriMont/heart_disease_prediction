...
def upgrade() -> None:
    ...
    sa.Column('has_disease', sa.Integer(), nullable=False),
    sa.Column('disease_probability', sa.Float(), nullable=False),
    sa.Column('result_text', sa.String(length=200), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
